...
def _create_theory_from_config(theory_config: Dict[str, Any], theory_name: str = "theory") -> Any:
    ...
    if theory_type == "xtb":
        ...
        # Set ORCA directory to full path for parallel runs
        orcadir = "/inspire/hdd/project/chemicalreaction/misixuan-CZXS24220243/soft/orca_6_0_1_linux_x86-64_shared_openmpi416_avx2"
